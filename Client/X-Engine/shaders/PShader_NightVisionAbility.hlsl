...
float4 PSNightVisionAbility(VSOutput_Tex pin) : SV_TARGET0
{
    ...
    //{
    //    float4 color1 = float4(0.2f, 0.2f, 0.2f, 1.f);
    //    float4 color2 = float4(0.4f, 0.4f, 0.4f, 1.f);
    //    litColor = lerp(color1, color2, rim);
    //}
    //else
    //{
    //    float4 color1 = float4(0.01f, 0.01f, 0.1f, 1.f);
    //    float4 color2 = float4(0.1f, 0.1f, 0.1f, 1.f);
    //    litColor = lerp(color1, color2, rim);
    //}
    float4 color1 = float4(0.01f, 0.01f, 0.1f, 1.f);
    float4 color2 = float4(0.3f, 0.3f, 0.3f, 3.f);
    litColor = lerp(color1, color2, rim);
