...
void GraphicsRootSignature::CreateDefaultGraphicsRootSignature()
{
	...
	Push(RootParam::Collider, D3D12_ROOT_PARAMETER_TYPE_32BIT_CONSTANTS, 3, 0, D3D12_SHADER_VISIBILITY_ALL, 20);
	...
	Push(RootParam::Bloom, D3D12_ROOT_PARAMETER_TYPE_32BIT_CONSTANTS, 8, 0, D3D12_SHADER_VISIBILITY_PIXEL, 5);
