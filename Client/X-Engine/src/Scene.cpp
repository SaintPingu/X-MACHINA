...
#pragma region MagicMissile
...

	{
		...
		pscd.StartSpeed = 0.f;
		pscd.StartSize = 2.f;
		pscd.StartColor.SetColor(PSColorOption::Color, Vec4{ 1.f, 0.5f, 0.3f, 0.3f });
		pscd.SimulationSpace = PSSimulationSpace::Local;
		pscd.MaxParticles = 11;
		pscd.Emission.SetBurst(1);
		pscd.Emission.RateOverTime = 0;
		pscd.SizeOverLifeTime = 1;
		pscd.ColorOverLifeTime.SetColor(Vec4{ 1.f, 1.f, 1.f, 1.f }, Vec4{ 0.2f, 0.05f, 0.05f, 0.f });
		pscd.Renderer.BlendType = BlendType::One_To_One_Blend;
...

	{
		...
		ParticleSystemCPUData pscd;
		pscd.mName = "Explosion_Sparkles_Mult";
		pscd.PlayOnAwake = false;
		pscd.Looping = false;
		pscd.Duration = 5.f;
		pscd.StartDelay = 0.f;
...

	{
		...
		ParticleSystemCPUData pscd;
		pscd.mName = "Explosion_Sparkles_Big";
		pscd.PlayOnAwake = false;
		pscd.Looping = false;
		pscd.Duration = 5.f;
		pscd.StartDelay = 0.05f;
		pscd.StartLifeTime = Vec2{ 0.2f, 0.35f };
		pscd.StartSpeed = Vec2{ 3.f, 4.f };
		pscd.StartSize = Vec2{ 0.08f, 0.12f };
		pscd.StartColor.SetColor(PSColorOption::Color, Vec4{ 1.f, 1.f, 1.f, 1.f });
		pscd.SimulationSpace = PSSimulationSpace::Local;
		pscd.GravityModifier = 0.15f;
		pscd.MaxParticles = 21;
		pscd.Emission.SetBurst(8);
		pscd.Emission.SetBurst(3, 0.1f);
		pscd.Emission.RateOverTime = 0;
		pscd.Shape.SetSphere(0.3f, 0.f, 360.f, false);
		pscd.ColorOverLifeTime.SetColor(Vec4{ 1.f, 1.f, 1.f, 1.f }, Vec4{ 1.f, 0.9f, 0.47f, 1.f });
		pscd.Renderer.BlendType = BlendType::One_To_One_Blend;
		pscd.Renderer.TextureName = "Explosion_Grow";
		pscd.SizeOverLifeTime = 1;
		component->SetPSCD(std::move(pscd));
...

	{
		...
		pscd.Emission.RateOverTime = 0;
		pscd.Shape.SetSphere(1.f, 0.1f, 360.f, false);
		pscd.ColorOverLifeTime.SetColor(Vec4{ 1.f, 1.f, 1.f, 1.f }, Vec4{ 0.7f, 0.5f, 0.f, 1.f });
		pscd.Renderer.BlendType = BlendType::One_To_One_Blend;
		pscd.Renderer.TextureName = "Explosion_Dot";
		pscd.Renderer.RenderMode = PSRenderMode::StretchedBillboard;
		component->SetPSCD(std::move(pscd));
...

	{
		...
		pscd.StartColor.SetColor(PSColorOption::Color, Vec4{ 3.f, 2.8f, 2.f, 1.f });
		pscd.SimulationSpace = PSSimulationSpace::Local;
		pscd.MaxParticles = 11;
		pscd.Emission.SetBurst(1);
		pscd.Emission.RateOverTime = 0;
...

	{
		...
		pscd.Shape.SetSphere(0.3f, 1.f, 360.f, false);
		pscd.SizeOverLifeTime = 1;
		pscd.ColorOverLifeTime.SetColor(Vec4{ 1.f, 1.f, 1.f, 1.f }, Vec4{ 0.3f, 0.3f, 0.3f, 0.f });
		pscd.Renderer.BlendType = BlendType::Alpha_Blend;
		pscd.Renderer.TextureName = "Explosion_Smoke";
		component->SetPSCD(std::move(pscd));
	}

	for (auto& particle : mParticles[0]->GetComponents<ParticleSystem>()) {
		particle->Save();
	}
