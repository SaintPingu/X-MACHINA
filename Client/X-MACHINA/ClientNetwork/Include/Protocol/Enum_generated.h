...
enum MONSTER_TYPE : uint8_t {
  MONSTER_TYPE_NONE = 0,
  MONSTER_TYPE_ADVANCED_COMBAT_DROIR_5 = 1,
  MONSTER_TYPE_ANGLEROX = 2,
  MONSTER_TYPE_ARACK = 3,
  MONSTER_TYPE_ARANOBOT = 4,
  MONSTER_TYPE_CERATOFEROX = 5,
  MONSTER_TYPE_GOBBLER = 6,
  MONSTER_TYPE_LIGHTBIPEDMECH = 7,
  MONSTER_TYPE_MININGMECH = 8,
  MONSTER_TYPE_ONYSCIDUS = 9,
  MONSTER_TYPE_URSACETUS = 10,
  MONSTER_TYPE_RAPAX = 11,
  MONSTER_TYPE_DEUS_PHASE_1 = 12,
  MONSTER_TYPE_DEUS_PHASE_2 = 13,
  MONSTER_TYPE_END = 14,
  MONSTER_TYPE_MIN = MONSTER_TYPE_NONE,
  MONSTER_TYPE_MAX = MONSTER_TYPE_END
};

inline const MONSTER_TYPE (&EnumValuesMONSTER_TYPE())[15] {
...
inline const char *EnumNameMONSTER_TYPE(MONSTER_TYPE e) {
  if (::flatbuffers::IsOutRange(e, MONSTER_TYPE_NONE, MONSTER_TYPE_END)) return "";
  const size_t index = static_cast<size_t>(e);
  return EnumNamesMONSTER_TYPE()[index];
}

enum MONSTER_BT_TYPE : uint8_t {
  MONSTER_BT_TYPE_NONE = 0,
  MONSTER_BT_TYPE_IDLE = 1,
  MONSTER_BT_TYPE_DEATH = 2,
  MONSTER_BT_TYPE_ATTACK = 3,
  ...
  MONSTER_BT_TYPE_CHANGE_BT = 9,
  MONSTER_BT_TYPE_END = 10,
  MONSTER_BT_TYPE_MIN = MONSTER_BT_TYPE_NONE,
...
inline const char *EnumNameMONSTER_BT_TYPE(MONSTER_BT_TYPE e) {
  if (::flatbuffers::IsOutRange(e, MONSTER_BT_TYPE_NONE, MONSTER_BT_TYPE_END)) return "";
  const size_t index = static_cast<size_t>(e);
...
enum PLAYER_SKILL_TYPE : uint8_t {
  PLAYER_SKILL_TYPE_NONE = 0,
  PLAYER_SKILL_TYPE_IMPOSSIBLE = 1,
  PLAYER_SKILL_TYPE_CLOACKING = 2,
  PLAYER_SKILL_TYPE_IR_DETECTOR = 3,
  PLAYER_SKILL_TYPE_MIND_CONTROL = 4,
  PLAYER_SKILL_TYPE_SHIELD = 5,
  PLAYER_SKILL_TYPE_END = 6,
  PLAYER_SKILL_TYPE_MIN = PLAYER_SKILL_TYPE_NONE,
  PLAYER_SKILL_TYPE_MAX = PLAYER_SKILL_TYPE_END
};

inline const PLAYER_SKILL_TYPE (&EnumValuesPLAYER_SKILL_TYPE())[7] {
  static const PLAYER_SKILL_TYPE values[] = {
    PLAYER_SKILL_TYPE_NONE,
...
inline const char *EnumNamePLAYER_SKILL_TYPE(PLAYER_SKILL_TYPE e) {
  if (::flatbuffers::IsOutRange(e, PLAYER_SKILL_TYPE_NONE, PLAYER_SKILL_TYPE_END)) return "";
  const size_t index = static_cast<size_t>(e);
