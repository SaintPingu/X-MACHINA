...
{
	mPSNames[static_cast<UINT8>(BulletPSType::Building)].push_back("WFX_DeusMissile_Explosion_Smoke");
	mPSNames[static_cast<UINT8>(BulletPSType::Building)].push_back("WFX_DeusMissile_Explosion_Add");
	mPSNames[static_cast<UINT8>(BulletPSType::Building)].push_back("WFX_DeusMissile_Dot_Sparkles");

	mPSNames[static_cast<UINT8>(BulletPSType::Explosion)].push_back("WFX_DeusMissile_Explosion_Smoke");
	mPSNames[static_cast<UINT8>(BulletPSType::Explosion)].push_back("WFX_DeusMissile_Explosion_Add");
